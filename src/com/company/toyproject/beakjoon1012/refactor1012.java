...
public class refactor1012 {
	...
	public static void MiroSearch(){
		for (int rowCycle = 0; rowCycle < miro.length; rowCycle++) {
			for (int columCycle = 0; columCycle < miro[1].length; columCycle++) {
				MiroRogic(rowCycle,columCycle);
			}
		}
	}

	public static void MiroRogic(int rowCycle, int columCycle){
	...
	public static void dfs(int x, int y) {
		...
		for (int i = 0; i < 4; i++) {
			...
			DFSLogic(nextX,nextY);
		}

	}

	public static void DFSLogic(int nextX , int nextY){
